...
from premium.entity.artifact_entity import DataIngestionArtifact, DataTransformationArtifact, DataValidationArtifact, ModelTrainerArtifact
...
class Pipeline:
    ...
    def start_data_validation(self, data_ingestion_artifact:DataIngestionArtifact) -> DataValidationArtifact:
        try:
            data_validation = DataValidation(
                data_validation_config = self.config.get_data_validation_pipeline_config(),
    ...
    def run_pipeline(self):
        try:
            ...
            model_trainer_artifact = self.start_model_trainer(data_transformation_artifact=data_trasformation_artifact)
